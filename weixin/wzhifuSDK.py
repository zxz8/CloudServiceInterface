...
class WxPayConf_pub(object):
    ...
    APPID = "wx27b4aeccb2628d52"
    #JSAPI接口中获取openid，审核后在公众平台开启开发模式后可查看
    APPSECRET = "400d1c316791b450a96cea9fd343ef8d"
    #受理商ID，身份标识
    MCHID = "1488020192"
    #商户支付密钥Key。审核通过后，在微信发送的邮件中查看
    KEY = "n4j16bmq3j7tz9wojy91qb88cyi4cbcb"
    ...
    #=======【证书路径设置】=====================================
    #证书路径,注意应该填写绝对路径
    SSLCERT_PATH = "/home/shop/testProject/collected_static/cacert/apiclient_cert.pem"
    SSLKEY_PATH = "/home/shop/testProject/collected_static/cacert/apiclient_key.pem"
...
class UnifiedOrder_pub(Wxpay_client_pub):
    ...
    def createXml(self):
        ...
        self.parameters["appid"] = WxPayConf_pub.APPID  #公众账号ID
        self.parameters["mch_id"] = WxPayConf_pub.MCHID  #商户号
        self.parameters["spbill_create_ip"] = "47.94.92.14"  #终端ip      
        self.parameters["nonce_str"] = self.createNoncestr()  #随机字符串
        self.parameters["sign"] = self.getSign(self.parameters)  #签名
        return  self.arrayToXml(self.parameters)
